...
#
# Generated by export_simulation on Sat Nov 14 16:26:21 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './c_shift_ram_7.sh' script.

./c_shift_ram_7.sh -reset_run
...
./c_shift_ram_7.sh -noclean_files

For more information on the script, please type './c_shift_ram_7.sh -help'.
